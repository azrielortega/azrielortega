...
Data Science student based in Milan 🇮🇹, building with LLMs & ML.

I'm interested in applied machine learning — from retrieval and semantic search to interpretable, production-minded data pipelines. Currently exploring how to make LLM-powered systems faster and more efficient.
...
`Python` · `tensorflow` · `Pandas` · `FAISS` · `Streamlit` · `SQL`
